...
class TodoItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create todo_item" do
    assert_difference('TodoItem.count') do
      post todo_items_url, params: { todo_item: { completed: @todo_item.completed, description: @todo_item.description, due_date: @todo_item.due_date, title: @todo_item.title } }
    end
  ...
  test "should update todo_item" do
    patch todo_item_url(@todo_item), params: { todo_item: { completed: @todo_item.completed, description: @todo_item.description, due_date: @todo_item.due_date, title: @todo_item.title } }
