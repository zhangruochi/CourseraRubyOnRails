...
class TodoListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create todo_list" do
    assert_difference('TodoList.count') do
      post todo_lists_url, params: { todo_list: { list_due_date: @todo_list.list_due_date, list_name: @todo_list.list_name } }
    end
  ...
  test "should update todo_list" do
    patch todo_list_url(@todo_list), params: { todo_list: { list_due_date: @todo_list.list_due_date, list_name: @todo_list.list_name } }
